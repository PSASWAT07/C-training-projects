...
namespace Network2
{
    internal class Networkk
    {
        public void gatherNetworkLog()
        {

            FileStream fileStream = new FileStream("C:\\Users\\sapani\\Documents\\Csharp application\\assignment\\Networklog.txt", FileMode.Open, FileAccess.Read); // 'new' allocates new memory
